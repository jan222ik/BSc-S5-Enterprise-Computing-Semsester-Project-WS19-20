...
public interface EventsApi {
    ...
    @ApiOperation(value = "Query a list of events based on a search string", nickname = "eventsFindByQueryStringGet", notes = "", response = Event.class, tags = {"events",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Request was successful, returns not empty result set found", response = Event.class),
    ...
    ResponseEntity<Event> eventsFindByQueryStringGet(@ApiParam(value = "QueryString used as a filter") @Valid @RequestParam(value = "queryString", required = false) String queryString);
